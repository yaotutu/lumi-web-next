				...
				<div className="flex flex-col items-start gap-6 md:flex-row">
					...
					<div className="flex-1 space-y-4">
						...
						<div className="flex flex-col gap-2 sm:flex-row sm:items-center">
							<span className="w-20 shrink-0 text-sm font-medium text-white/60">用户名</span>
							{isEditing ? (
								<input
									type="text"
									value={name}
						...
						{/* 邮箱 */}
						<div className="flex flex-col gap-2 sm:flex-row sm:items-center">
							<span className="w-20 shrink-0 text-sm font-medium text-white/60">邮箱</span>
							<span className="text-sm text-white/90">{user?.email || "未绑定"}</span>
						</div>

						{/* 个人简介 */}
						<div className="flex flex-col gap-2 sm:flex-row sm:items-start">
							<span className="w-20 shrink-0 text-sm font-medium text-white/60">个人简介</span>
							{isEditing ? (
								<textarea
									value={bio}
						...
						{/* 注册时间 */}
						<div className="flex flex-col gap-2 sm:flex-row sm:items-center">
							<span className="w-20 shrink-0 text-sm font-medium text-white/60">注册时间</span>
				...
				<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
					{stats.map((stat) => (
						<div key={stat.label} className="glass-panel p-4 text-center">
							...
							<div className="mb-1 text-2xl font-bold text-yellow-1">{stat.value}</div>
